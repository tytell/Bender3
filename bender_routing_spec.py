...
BENDER_ROUTING: Dict[str, Route] = {
    ...
    "left_stim_voltage":      {"tier": "metadata", "key": "protocol_stim_voltage_left_volt",   "required": False, "source": "GUI",
                               "note": "operator S88 dial setting (metadata only); does NOT drive the AO -- see stim_trigger_pulse_volt"},
    "right_stim_voltage":     {"tier": "metadata", "key": "protocol_stim_voltage_right_volt",  "required": False, "source": "GUI",
                               "note": "operator S88 dial setting (metadata only); does NOT drive the AO -- see stim_trigger_pulse_volt"},
    "stim_trigger_pulse_volt": {"tier": "metadata", "key": "protocol_stim_trigger_pulse_volt", "required": False, "source": "computed",
                                "note": "fixed height (V) of the AO trigger pulse train sent to the S88; NOT the delivered amplitude (S88 dials set that, recorded on stim_monitor)"},
