...
BENDER_ROUTING: Dict[str, Route] = {
    ...
    "apparatus_id":       {"tier": "metadata", "key": "session_apparatus_id",    "required": False, "source": "config"},
    "session_analyst":    {"tier": "metadata", "key": "session_analyst",         "required": False, "source": "GUI"},
    "simulation_mode":    {"tier": "metadata", "key": "session_simulated",       "required": True,  "source": "computed",
    ...
    "simulation_material": {"tier": "metadata", "key": "session_simulation_material", "required": False, "source": "GUI",
                            "note": "meaningful only when simulation_mode True"},
    ...
    "reset_between_steps":    {"tier": "metadata", "key": "protocol_reset_between_steps",       "required": False, "source": "GUI"},
    "hold_motor_between_steps": {"tier": "metadata", "key": "protocol_hold_motor_between_steps", "required": False, "source": "GUI"},
