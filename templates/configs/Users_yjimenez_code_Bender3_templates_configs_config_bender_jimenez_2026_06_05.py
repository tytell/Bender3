# -*- coding: utf-8 -*-
"""Auto-generated by CritterGripper. Template: jimenez_bender_config_B. Edit freely after load."""
...
sono_channel = ['ai6']
sono_distance = ''
sono_inhibit_delay = 0.0
sono_internal_samplefreq = 242
sono_name = ['sono_right']
sono_transmit_pulse = 0.0
