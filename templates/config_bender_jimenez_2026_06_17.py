# -*- coding: utf-8 -*-
"""Auto-generated by CritterGripper. Template: Users_yjimenez_code_Bender3_templates_configs_config_bender_jimenez_2026_06_05. Edit freely after load."""
S1side = 'left'
S2side = 'right'
SG_chan = ['ai0', 'ai1', 'ai2', 'ai3', 'ai4', 'ai5']
SG_name = ['xForce', 'yForce', 'zForce', 'xTorque', 'yTorque', 'zTorque']
amp_step_vel = 10
apparatus_id = 'jimenez'
...
sono_cal_right = [3.4, 4.5, 35.3, 47.0]
sono_channel = ['ai6']
sono_distance = ''
sono_inhibit_delay = 4.72
sono_internal_samplefreq = 247
sono_name = ['sono_right']
sono_transmit_pulse = 312.5
