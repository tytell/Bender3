...
- Calibrated F/T, inertial-corrected torque — authoritative copies live in hub `derived/` (R-computed); the raw file additionally carries an exporter-written `derived/` group for live RA inspection only (D11 amendment, Point 4), which R ignores
